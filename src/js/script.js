...
const hideOrDiplayPassword = document.querySelectorAll(".form-control i")
...
hideOrDiplayPassword.forEach((btn) => {
btn.addEventListener("click", () => {

    if (confirmPassword.type === "password"){
        confirmPassword.setAttribute("type","text")
        passawordInput.setAttribute("type","text")
        hideOrDiplayPassword.forEach(btn => {
        ...
        passawordInput.setAttribute("type","password")
        hideOrDiplayPassword.forEach(btn => {
